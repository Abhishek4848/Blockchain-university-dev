...
class GenerateForm extends React.Component {
  state = {
    ...
    orgLogo: "https://pes.edu/wp-content/uploads/2021/05/pesu-logo.png",
    coursename: "",
    assignedOn: null,
    duration: 0,
    currentState: "normal",
    ssn: "",
    certificateId: this.props.match.params.id
  };
              ...
              <Grid item xs={12} sm={12}>
                ...
                {currentState === "validate" && (
                  <Typography
                    ...
                    className={classes.submitBtn}
                  >
                    Certificate genrated with id <a href={"http://localhost:3002/token/"+ssn}>{certificateId}</a>
                  </Typography>
                )}
                {currentState === "error" && (
                  <Typography
                  ...
                  className={classes.submitBtn}
                >
                  Certificate with id {certificateId} already exits.
                </Typography>
                )}
              </Grid>
            </form>
