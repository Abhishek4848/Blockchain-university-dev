...
import credit_contract_abi from './Contracts/credit_contract_abi.json'
import Interactions from './Interactions';

const Wallet = () => {

	// contract deploy address
	let contractAddress = '0x3c540Bb5fd2647a3eDa89Be4bffC300E594Da522';
   ...
   return x;
	...
	const updateEthers = () => {
		...
		let tempContract = new ethers.Contract(contractAddress, credit_contract_abi, tempSigner);
